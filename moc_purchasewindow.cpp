...
QT_MOC_LITERAL(1, 15, 20), // "on_navButton_clicked"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "PurchaseWindow\0on_navButton_clicked\0"
    ""
};
...
void PurchaseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PurchaseWindow *_t = static_cast<PurchaseWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_navButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject PurchaseWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PurchaseWindow.data,
      qt_meta_data_PurchaseWindow,  qt_static_metacall, nullptr, nullptr}
};
